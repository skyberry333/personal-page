const META_DESCRIPTION = 'Nicholas Xu, Instagran photographer, ametaur programmer and daily connoisseur. ';
...
module.exports = {
  ...
  head: {
    ...
    meta: [
      ...
      {property: 'og:url', content: 'http://tichx.com/'},
      {property: 'og:image', content: 'http://tichx.com/Nicholas-FB-Share.jpg'},
